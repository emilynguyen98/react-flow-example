...
export const nodes = [
  {
    ...
    data: {
      label: (
        <>
          Good morning, Emily! Thank you so much for coming in. My name is Joe, and I am the supervisor for this department. I will be conducting this interview for the position of a Game Developer.
        </>
      ),
